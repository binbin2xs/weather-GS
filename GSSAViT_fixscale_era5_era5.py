...
class ViT(BaseModel):
    ...
    def decoder_forward(self, x):
        ...
        x_channel = self.mlp_block_channel(x) 
        x_gaussian = self.mlp_block_gaussian(x)
    ...
    def forward(self, x, gt, **kwargs):
        ...
        with torch.no_grad():
            x = self.interpolate_data_2d(x, size=(48, 96))
...
class SuperFormer_v2(BaseModel):
    ...
    def forward(self, input, gt, step=0, **kwargs):
        return  self.arch_net(input, gt, **kwargs)
