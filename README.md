...
source ../cf3dgs/bin/activate
bash /cpfs/hantao/CF-3DGS/run_weather_recon.sh
CUDA_VISIBLE_DEVICES=0 python run_cf3dgs.py --sh_degree 0 --start_time 2020-01-02 --end_time 2020-01-03
python run_cf3dgs_parralel.py --gpus 0-15 --gl_start_time 2008-01-01 --gl_end_time 2023-12-31




srun -p normal --account=peilab --time=480 --gres=gpu:1  --pty /bin/bash 
squeue -u $USER
scancel 12345
srun --jobid=203981 --overlap --pty /bin/bash

rclone mount ali:openearth-aliyun/era5_np_float32 /project/peilab/dataset/era5_np_float32
```
